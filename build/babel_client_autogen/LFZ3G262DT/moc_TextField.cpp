/****************************************************************************
** Meta object code from reading C++ file 'TextField.hpp'
**
...
#include "../../../include/Client/Qt/TextField.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'TextField.hpp' doesn't include <QObject>."
...
const QMetaObject TextField::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_TextField.data,
      qt_meta_data_TextField,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
